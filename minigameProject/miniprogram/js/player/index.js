...
export default class Player extends Sprite {
  ...
  initEvent() {
    ...
    canvas.addEventListener('touchstart', this.touchstartHandle)
    ...
    canvas.addEventListener('touchmove', this.touchmoveHandle)
    ...
    canvas.addEventListener('touchend', this.touchendHandle)
  }
